<?php return array (
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'pusher',
        'key' => '2a2e5439c79a17e6badd',
        'secret' => 'da8cf3b393150060aba1',
        'app_id' => '716243',
        'options' => 
        array (
          'cluster' => 'eu',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'file',
        'path' => '/var/www/livechat/html/storage/framework/cache/data',
      ),
      'memcached' => 
      array (
        'driver' => 'memcached',
    ...
    'prefix' => 'portal_it_department_cache',
  ),
  'database' => 
  array (
    'default' => 'mysql',
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          'disk' => 'obmen',
          'path' => 'ЗАМЕСТИТЕЛИ  ГЛАВНОГО ВРАЧА',
          'access' => 2,
        ),
        1 => 
        array (
        ...
        array (
          'disk' => 'obmen',
          'path' => 'А Д М И Н И С Т Р А Ц И Я',
          'access' => 2,
        ),
        3 => 
        array (
        ...
        array (
          'disk' => 'obmen',
          'path' => '_ЗАВ КАНЦЕЛЯРИИ МОКРОУСОВА Л.И',
          'access' => 2,
        ),
        5 => 
        array (
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'local',
        'root' => '/var/www/livechat/html/storage/app',
      ),
      'public' => 
      array (
        'driver' => 'local',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'single',
        'path' => '/var/www/livechat/html/storage/logs/laravel.log',
        'level' => 'debug',
      ),
      'daily' => 
      array (
  ...
  array (
    ...
    array (
      ...
      'paths' => 
      array (
        0 => '/var/www/livechat/html/resources/views/vendor/mail',
      ),
    ),
    'log_channel' => NULL,
  ),
  ...
  array (
    ...
    'cookie' => 'portal_it_department_session',
    'path' => '/',
    'domain' => NULL,
    'secure' => false,
    'http_only' => true,
  ...
  array (
    'paths' => 
    array (
      0 => '/var/www/livechat/html/resources/views',
    ),
    'compiled' => '/var/www/livechat/html/storage/framework/views',
  ),
  'debug-server' => 
  array (
  ...
  array (
    ...
    'paths' => 
    array (
      0 => '/var/www/livechat/html/public/upload',
      1 => '/var/www/livechat/html/public/images',
    ),
    'templates' => 
    array (
