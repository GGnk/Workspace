            ...
            <div class="col-auto">
                ...
                <div class="btn-group" role="group">
                    <!--<button type="button" class="btn btn-primary"
                        ...
                        <i class="far fa-file"></i><span>{{lang.btn.file}}</span>
                    </button>-->
                    <button type="button" class="btn btn-primary"
                            v-on:click="showModal('NewFolder')"
                            v-bind:title="lang.btn.folder">
                        <i class="far fa-folder"></i><span>{{lang.btn.folder}}</span>
                    </button>
                    <button type="button" class="btn btn-light"
                            disabled
                            v-if="uploading"
                            v-bind:title="lang.btn.upload">
                        <i class="fas fa-download"></i><span>{{lang.btn.upload}}</span>
                    </button>
                    <button type="button" class="btn btn-light"
                            v-else
                    ...
                    <button type="button" class="btn btn-danger"
                        ...
                        <i class="fas fa-trash-alt"></i><span>{{lang.btn.delete}}</span>
                    </button>
                </div>
                <div class="btn-group" role="group">
                    <button type="button" class="btn btn-light"
                        ...
                        <i class="fas fa-copy"></i><span>{{lang.btn.copy}}</span>
                    </button>
                    <button type="button" class="btn btn-light"
                            v-bind:title="lang.btn.cut"
                            v-on:click="toClipboard('cut')">
                        <i class="fas fa-cut"></i><span>{{lang.btn.cut}}</span>
                    </button>
                    <button type="button" class="btn btn-light"
                            v-bind:disabled="!clipboardType"
                            v-bind:title="lang.btn.paste"
                            v-on:click="paste">
                        <i class="fas fa-paste"></i><span>{{lang.btn.paste}}</span>
                    </button>
                </div>
            </div>
